...
\begin{center}
    \vspace*{1cm}
    \includegraphics[width=0.8\textwidth]{../have/基于Linux的简易差速驱动机器人运动仿真实现/Logo.png}
\end{center}

\vspace{2.2cm}
\begin{center}
    {\zihao{1}\heiti 毕业设计开题报告}
\end{center}

\vspace{1.5cm}
\begin{center}
    {\zihao{3} 差速驱动移动机器人的运动仿真与控制研究与实现}
\end{center}

\vspace{2.2cm}
\begin{center}
\renewcommand{\arraystretch}{2}
\begin{tabular}{>{\heiti}p{3cm} >{\centering\arraybackslash}p{8cm}}
    院\quad \quad 系： & 工程系 \\ \cline{2-2}
    专\quad \quad 业： & 电子与计算机工程 \\ \cline{2-2}
    班\quad \quad 级： & 三班 \\ \cline{2-2}
    姓\quad \quad 名： & 刘济伟 \\ \cline{2-2}
    学\quad \quad 号： & 1120220518 \\ \cline{2-2}
    指导教师： & 郑建波 \\ \cline{2-2}
    日\quad \quad 期： & 2026 年 3 月 26 日 \\ \cline{2-2}
\end{tabular}
\end{center}
